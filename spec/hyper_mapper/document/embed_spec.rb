...
describe 'HyperMapper::Document::Embed' do
  ...
  describe "embeds_many" do
    ...
    it "should create 2 posts for two subsequent create calls" do
      stub_auto_id_map_add 'users', @user.username, {title: 'test'}
      @user.posts.create! title: 'test'
      stub_auto_id_map_add 'users', @user.username, {title: 'test2'}
      @user.posts.create! title: 'test'
    end
  end
  ...
  describe "embedded_in" do
    ...
    it "should not persist the parent object" do
      @post.title = 'a new title'
      @user.email = 'new@example.com'
      stub_map_add 'users', 'goggin13', @post.id, {title: 'a new title'}.to_json
      @post.save
    end
    ...
    describe "destroy" do
      ...
      before do
        stub_map_remove 'users', @user.username, {'posts' => @user.posts[0].id}
      end
