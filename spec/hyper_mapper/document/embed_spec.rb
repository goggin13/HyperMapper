...
describe 'HyperMapper::Document::Embed' do
  ...
  describe "embeds_many" do
    ...
    it "should create 2 posts for two subsequent create calls" do
      ...
      @user.posts.create! title: 'test', id: "3"
      stub_put 'users', 'goggin13', {
        posts: { 
          "1" => "{\"title\":\"Hello world\"}", 
          "2" => "{\"title\":\"Goodbye world\"}",
      ...
      @user.posts.create! title: 'test2', id: "4"
    end
  end
  ...
  describe "embedded_in" do
    ...
    it "should set an autogenerated id on the child" do
      ...
      @client.should_receive(:put) do |s, k, attrs|
        s.should == 'users'
        k.should == 'goggin13'
        attrs[:posts].each do |id, val|
          id.length.should == 32
          val.should == "{\"title\":\"test2\"}"
        end
      end
